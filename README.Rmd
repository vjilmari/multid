...
*multid* also includes a function for testing several hypothesis that are typically compressed to correlation between predictor (x) and an algebraic difference score (y1-y2) by deconstructing this difference score correlation (**ddsc_sem**). 
