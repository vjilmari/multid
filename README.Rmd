...
See fully reproducible exemplary [vignette on multivariate sex differences in personality with regularized regression](https://cran.r-project.org/web/packages/multid/vignettes/multivariate_sex_differences_in_personality.html), or examples presented below.
